...
# Local dir inside Colab VM where the dataset will live (/content is fast;
# Drive is slow + rate-limited for many small files).
LOCAL_DATASET_DIR = "/content/finetune_ru"
# URL to the pre-packaged dataset ZIP (committed in the repo). Default
# points at this branch's colab_release/ snapshot.
DATASET_ZIP_URL = (
...
out_dir = pathlib.Path("__DRIVE_OUTPUT_DIR__") / 'out'
...
def render(
    ...
    return (
        ...
        .replace("__DRIVE_OUTPUT_DIR__", drive_output_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--drive-out", default=DRIVE_OUTPUT_DIR)
    parser.add_argument("--epochs", type=int, default=EPOCHS)
    parser.add_argument("--batch-size", type=int, default=BATCH_SIZE)
    args = parser.parse_args()

    print(render(
        args.zip_url, args.local_dir, args.drive_out,
